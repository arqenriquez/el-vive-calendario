...
function renderFiltros() {
  ...
  const opciones = [
    `<button class="filter-option is-active" role="menuitemcheckbox" aria-checked="true" data-cat="todos" style="--cat:var(--vino)"><span class="dot"></span>Todos<span class="check" aria-hidden="true">✓</span></button>`,
  ];
...
function sincronizarMenuFiltro() {
  ...
  toggle.style.setProperty("--cat", n === 1 ? CATEGORIAS[primero].color : "var(--vino)");
}
